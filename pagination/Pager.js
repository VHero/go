          ...
          url:'php/Pager.php',
           ...
           handler:function (dataString) {
               ...
               for(var i = 0,htmlString;i<data.length - 1;i++){
                   ...
                   var dataObj = data[i];
                   htmlString = "<img src="+data[i]['pic']+">"+"<p>"+data[i]['article']+"</p>";
                   html.push(htmlString);

                   // var dataObj = data[i];
                   // htmlString = "<tr><td>"+dataObj['name']+"</td><td>"+dataObj['price']+"</td>" +
                   //     "<td>"+dataObj['count']+"</td><td>"+dataObj['product_desc']+"</td></tr>";
                   // html.push(htmlString);
               }
