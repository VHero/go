            ...
            page =  new Pager({
                ...
                handler:function (dataString) {
                    ...
                    for(var i = 0,htmlString;i<data.length - 1;i++){
                        ...
                        htmlString ="<article class='post'>"+
                            "<div class='post-head'>"+
                            "<h1 class='post-title'>"+ dataObj['title']+ "</h1>"+
                            "<div class='post-meta'>"+
                            "<span class='author'>作者："+dataObj['author']+"</span> •"+
                    "<time class='post-date' >"+dataObj['date']+"</time>"+
                        "</div>"+
                        "</div>"+
