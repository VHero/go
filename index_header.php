<nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="index.php">上学</a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="./service/ourservice/html/course.php">论文辅导</a></li>
                                <li><a href="./service/ourservice/html/paper.php">作业辅导</a></li>
                                <li><a href="./service/ourservice/html/task.php">课程辅导</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
