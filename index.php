        ...
        <nav class="navbar navbar-default navbar-fixed-top" role="navigation" style="">
            <div class="container">
                ...
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="#">上学</a>
                </div>
                    ...
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu" role="menu">
                                <li><a href="./service/ourservice/html/course.html">论文辅导</a></li>
                                <li><a href="./service/ourservice/html/paper.html">作业辅导</a></li>
                                <li><a href="./service/ourservice/html/task.html">课程辅导</a></li>
                            </ul>
                        </li>
                    </ul>
                </div><!-- /.navbar-collapse -->
                    ...
                    <div class="col-sm-4 col-md-4">
                        <div class="thumbnail">
                            ...
                            <div class="caption">
                                ...
                                <p class="text-center"><a href="#" class="btn btn-primary" role="button">立即咨询</a></p>
                            </div>
                        </div>
                    </div>
                    <div class="col-sm-4 col-md-4">
